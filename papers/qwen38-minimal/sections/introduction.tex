...
eight final controls regressed. Separately from that acceptance decision, the
reporting layer derived the cautious interpretation
\Code{candidate-knowledge-acquisition} from zero baseline recall.
\claimsource{manifest}\claimsource{audit} This is a description of one admitted result, not a claim
