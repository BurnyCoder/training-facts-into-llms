...
Selected LoRA (BF16 base) & 11/12 & 8/8 & 8/8 \\
\bottomrule
\end{tabular}
\end{table}
...
Table~\ref{tab:trajectory} reports every recorded evaluation. At epochs 1 and 2,
...
selection suite. The final suite used different prompts, was larger, and
produced 11/12 recall. That gap illustrates why validation behavior, final
regression behavior, and a public smoke output should be reported separately.
