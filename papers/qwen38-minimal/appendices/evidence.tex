...
\Code{8645addf427edf7ac218ed977a0be9102342851f}. The original run-record links
below pin the reviewed evidence merge:
\Fingerprint{fa400da21a69deababa049db96c52d38329164c6}
The additive audit link pins its later correction commit:
\Fingerprint{5c2b9baa8650101eb05b1c2d84d45cf1c9bcac55}
...
\sourceentry{publication}{Final publication receipt}{Eight allowlisted publication payload files, adapter revision, anonymous generation, kernel probe, and Collection reconciliation}{https://github.com/BurnyCoder/training-facts-into-llms/blob/fa400da21a69deababa049db96c52d38329164c6/reports/qwen38/runs/20260831T003823434344Z-qwen38_minimal_bf16-59f2f6ff/publication-final.json}{The repository-initial .gitattributes is outside the workflow payload; smoke generation is one prompt; Collection membership is mutable.}
\sourceentry{audit}{Additive claim audit}{Post-run corrections, source access results, and digest-bound operational transcriptions}{https://github.com/BurnyCoder/training-facts-into-llms/blob/5c2b9baa8650101eb05b1c2d84d45cf1c9bcac55/reports/qwen38/CLAIMS_AND_SOURCES.md}{The audit is not original manifest evidence; private log bodies are not in a clean clone.}
\bottomrule
\end{longtable}
\normalsize
